...
diseases_list = {
    ...
    31: 'Osteoarthritis', 5: 'Arthritis', 0: 'Vertigo (Positional Vertigo)', 2: 'Acne', 38: 'Urinary tract infection',
...
def predict():
    if request.method == 'POST':
        ...
        return render_template('index.html', predicted_disease=predicted_disease, dis_desc=desc,
